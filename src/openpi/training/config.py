...
_CONFIGS = [
    ...
    TrainConfig(
     ...
     TrainConfig(
      name="pi05_0319_pick_and_place_block_30hz_chunk30_lora",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      name="pi05_0319_pnp_zlg_chunk30_30hz_lora_wx",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      name="pi05_wrench_chunk30_30hz_bs32_nonorm_lora",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      name="pi05_tube_200_chunk30_30hz_bs32_nonorm_lora",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      name="pi05_better_tube_200_chunk30_30hz_bs32_nonorm_full_pytorch",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      name="pi05_better_wrench_200_chunk30_30hz_bs32_nonorm_full_pytorch",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      ...
      data=LeRobotLift2DataConfig(
          repo_id="power_strip_refined_100_30hz_nonorm",
          default_prompt="Move the power strip with the left arm, and press the button of the power strip with the right arm.",
          use_quantile_norm=False,
      ),
      weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
      pytorch_weight_path="./checkpoints/pi05_pytorch",
    ...
    TrainConfig(
      name="pi05_better_towel_refined_150_chunk30_30hz_bs32_nonorm_full_pytorch",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
      ...
      data=LeRobotLift2DataConfig(
          repo_id="towel_refined_150_30hz_nonorm",
          default_prompt="Flatten the towel.",
          use_quantile_norm=False,
      ),
      weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
      name="pi05_towel_refined_150_chunk30_30hz_bs32_nonorm_full_pytorch",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      name="pi05_size_100_chunk30_30hz_bs32_nonorm_full_pytorch",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
      ...
      data=LeRobotLift2DataConfig(
          repo_id="size_100_30hz_nonorm",
          default_prompt="Pick up the four randomly placed cylinders and insert each one into the matching hole according to its size.",
          use_quantile_norm=False,
      ),
      weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
      pytorch_weight_path="./checkpoints/pi05_pytorch",
    ...
    TrainConfig(
      name="pi05_dice_100_chunk30_30hz_bs32_nonorm_full_pytorch",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      name="pi05_tube_chunk30_30hz_bs32_nonorm_full_pytorch",
      model=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
    ...
    TrainConfig(
      ...
      num_train_steps=100_000,
      batch_size=16,
      optimizer=_optimizer.AdamW(accumulation_steps=2),
      freeze_filter=pi0_config.Pi0Config(
          pi05=True,
          action_horizon=30,
          paligemma_variant="gemma_2b_lora",
